...
const topicIcons = {
  ...
  Prayer: `
    ...
    <path d="M8 8.5C8 5 9.5 4 12 4c2.5 0 4 1 4 4.5v7c0 3-1.5 4.5-4 4.5s-4-1.5-4-4.5z"></path>
    <path d="M4 14c0-2.5 1.5-4.5 4-5.5"></path>
    <path d="M20 14c0-2.5-1.5-4.5-4-5.5"></path>
    <path d="M4 14c0 3 2 5.5 4 6"></path>
    <path d="M20 14c0 3-2 5.5-4 6"></path>
  `,
  Comfort: `
  ...
  "Christian Living": `
    ...
    <path d="m14 8-3.5 5 3.5 3-1 6"></path>
    <path d="m10.5 13-4 1.5-2.5 5.5"></path>
    <path d="m7.5 10 3.5-2 3.5 2 3-1.5"></path>
  `,
  Sabbath: `
  ...
  `,
  "State of the Dead": `
    <path d="M3 21h7l-7-8h7"></path>
    <path d="M12 13h5l-5-5h5"></path>
    <path d="M17 6h4l-4-4h4"></path>
  `,
  "Great Controversy": `
    <path d="M12 19c-2-2-4.5-4-8-4 0-4 2-7.5 7-9-1 2.5 0 4.5 2 5.5"></path>
    <path d="M12 19c2-2 4.5-4 8-4 0-4-2-7.5-7-9 1 2.5 0 4.5-2 5.5"></path>
    <path d="M8 15c-1.5-1.5-2-3.5-2-5.5"></path>
    <path d="M16 15c1.5-1.5 2-3.5 2-5.5"></path>
  `,
  "Holy Spirit": `
    <path d="M19 14c1.49-1.46 3-3.21 3-5.5A4.5 4.5 0 0 0 17.5 4c-1.8 0-3.05.8-3.5 1.5C13.55 4.8 12.3 4 10.5 4A4.5 4.5 0 0 0 6 8.5c0 2.29 1.51 4.04 3 5.5"></path>
    <path d="M12 5v14"></path>
    <path d="M9 19c1 1 2 1.5 3 1.5s2-.5 3-1.5"></path>
    <path d="M7 11.5c1.5 1.5 3.5 2.5 5 2.5s3.5-1 5-2.5"></path>
  `,
  Baptism: `
    <path d="M12 2.5C12 2.5 6 9 6 13a6 6 0 0 0 12 0c0-4-6-10.5-6-10.5Z"></path>
    <path d="M2 18c2.5 1.5 5 1.5 7.5 0s5-1.5 7.5 0 3.5 1 4.5 0"></path>
    <path d="M2 21.5c2.5 1.5 5 1.5 7.5 0s5-1.5 7.5 0 3.5 1 4.5 0"></path>
  `,
  "Marriage and Family": `
  ...
  "The Church": `
    <path d="M12 2v4"></path>
    <path d="M10 4h4"></path>
    <path d="m18 10-6-4-6 4v11a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1z"></path>
  ...
  Forgiveness: `
    <path d="M8 3v18"></path>
    <path d="M3 8h10"></path>
    <path d="M18 9.5c-1.5 2-3 3.5-3 5.5a3 3 0 0 0 6 0c0-2-1.5-3.5-3-5.5Z"></path>
  `,
  "Bible Study": `
    <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path>
    <path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path>
    <path d="M17 14l4-4 1.5 1.5-4 4-2 .5.5-2z"></path>
  `,
  Health: `
...
function renderTopicFilters() {
  ...
  allTopics().forEach((topic) => {
    ...
    button.innerHTML = `<span>${topic}</span><strong>${count}</strong>`;
