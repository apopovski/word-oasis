...
<html lang="en">
  <head>
    ...
    <meta property="og:image" content="${SITE_URL}/og-image.png?v=20260924">
    ...
    <meta name="twitter:image" content="${SITE_URL}/og-image.png?v=20260924">
      ...
      <div class="container">
        <div class="footer-grid">
          ...
          <nav class="footer-col" aria-label="Connect with Word Oasis">
            ...
            <ul class="footer-list">
              <li><a href="/#ask">Ask a question</a></li>
              <li><a href="mailto:wordoasis7@gmail.com">Email us</a></li>
