...
<html lang="en">
  <head>
    ...
    <meta property="og:image" content="${SITE_URL}/og-image.png?v=20260922">
    ...
    <meta name="twitter:image" content="${SITE_URL}/og-image.png?v=20260922">
  ...
  <body>
    ...
    <script src="/theme.js?v=20260922"></script>
  </body>
</html>
`;
}
