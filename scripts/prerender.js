          ...
          <article class="answer-page-card" data-answer-page data-answer-id="${escapeAttribute(answer.id)}" data-answer-category="${escapeAttribute(answer.category)}">
            ...
            <details class="bible-study-invitation" data-bible-study>
              <summary>
                ...
                <span>
                  <strong>Continue your Bible study</strong>
                  <small>Explore free interactive studies on Word Oasis</small>
                </span>
                <span class="bible-study-summary-action">
                  <span class="bible-study-action-closed">Explore studies</span>
                  <span class="bible-study-action-open">Close</span>
                </span>
              </summary>
              <div class="bible-study-content">
                <p>Build on this answer with a guided, self-paced Bible study from the Word Oasis collection.</p>
                <a class="bible-study-submit" href="/studies/">
