...
<html lang="en">
  <head>
    ...
    <meta property="og:image" content="${SITE_URL}/og-image.png?v=20261003">
    ...
    <meta name="twitter:image" content="${SITE_URL}/og-image.png?v=20261003">
  ...
  <body>
    ...
    <script src="/theme.js?v=20261003"></script>
    <script src="/verse-modal.js?v=20261003"></script>
  </body>
</html>
`;
}
