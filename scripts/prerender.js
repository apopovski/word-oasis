...
<html lang="en">
  <head>
    ...
    <meta property="og:image" content="${SITE_URL}/og-image.png?v=20260920">
    ...
    <meta name="twitter:image" content="${SITE_URL}/og-image.png?v=20260920">
  ...
  <body>
    ...
    <script src="/theme.js?v=20260920"></script>
  </body>
</html>
`;
}
