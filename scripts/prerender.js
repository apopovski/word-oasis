...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/styles.css?v=20261122">
  ...
  <body>
        ...
        <ul id="primary-menu" class="nav-links">
          ...
          <li class="nav-item-dropdown">
            ...
            <ul class="nav-dropdown-menu" id="nav-learn-menu">
              <li><a href="/bible/"${currentPage("bible")}><svg class="nav-dropdown-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M4 5.5A2.5 2.5 0 0 1 6.5 3H11a3 3 0 0 1 3 3v15a3 3 0 0 0-3-3H6.5A2.5 2.5 0 0 0 4 20.5z"></path><path d="M20 5.5A2.5 2.5 0 0 0 17.5 3H14v18a3 3 0 0 1 3-3h.5a2.5 2.5 0 0 1 2.5 2.5z"></path></svg>Bible</a></li>
              <li><a href="/studies/"${currentPage("studies")}><svg class="nav-dropdown-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3 2 8l10 5 10-5-10-5Z"></path><path d="M6 10.5V16c0 1.6 2.7 3 6 3s6-1.4 6-3v-5.5"></path><path d="M22 8v6.5"></path></svg>Bible Studies</a></li>
              <li><a href="/quizzes/"${currentPage("quizzes")}><svg class="nav-dropdown-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="m9 11 3 3 8-9"></path><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path></svg>Quizzes</a></li>
            </ul>
          </li>
    ...
    <script src="/verse-modal.js?v=20261122"></script>
