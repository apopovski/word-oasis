...
<html lang="en">
  <head>
    ...
    <meta property="og:image" content="${SITE_URL}/og-image.png?v=20261002">
    ...
    <meta name="twitter:image" content="${SITE_URL}/og-image.png?v=20261002">
  ...
  <body>
    ...
    <script src="/theme.js?v=20261002"></script>
    <script src="/verse-modal.js?v=20261002"></script>
  </body>
</html>
`;
}
